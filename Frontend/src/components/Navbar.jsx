      ...
      <div className="nav-links">
        ...
        {role === "citizen" && (
          <>
            ...
            <Link className={location.pathname === "/feed" ? "active" : ""} to="/feed">Issues</Link>
            <Link className={location.pathname === "/map" ? "active" : ""} to="/map">Map</Link>
        ...
        {role === "admin" && (
          <>
            ...
            <Link to="/admin/issues">Manage</Link>
